...
class SlideWindow:
    ...
    def slidewindow(self, img):
        ...
        # draw line
        pts_left = np.array([[185, height], [185, height - 60], [285, height - 80], [285, height]], np.int32)
        cv2.polylines(out_img, [pts_left], False, (0,255,0), 1)
        pts_right = np.array([[380, height], [380, height - 80], [480, height - 110], [480, height]], np.int32)
        ...
        good_left_inds = ((nonzerox >= 235-50) & (nonzeroy >= nonzerox * 0.33 + 307) & (nonzerox <= 235+50)).nonzero()[0]
        good_right_inds = ((nonzerox >= 430-50) & (nonzeroy >= nonzerox * (-0.48) + 580) & (nonzerox <= 430+50)).nonzero()[0]
